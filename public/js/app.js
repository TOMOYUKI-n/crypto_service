...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      errored: false,
      isChecked: false //targetId: "1284754391442968578",
  ...
  methods: {
    manualFollow: function manualFollow(key) {
      ...
      console.log(data);
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/account", data).then(function (res) {
        self.postResponce = _this.res.data;
